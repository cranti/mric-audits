function joinedStr = strjoin_CR(c, aDelim)
%STRJOIN  Join cell array of strings into single string
%
%NOTE: copied by Carolyn - this is from later version of MATLAB, but I
%wanted to use it on 2012a. Modified a smidge. Should maybe check
%modifications.... **strescape
%
...
if isstr(aDelim)
    ...
    escapedDelim = aDelim; %CR edit: strescape(aDelim);
